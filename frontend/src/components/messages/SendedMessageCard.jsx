...
const SendedMessageCard = () => {
  return (
    <div className="flex w-full justify-end items-center">
      <div className="bg-red-200 px-2 py-2 rounded-md flex flex-col gap-1">
        ...
        <p className="whitespace-normal ">this is a message that is sended to a use that should be shown.</p>
